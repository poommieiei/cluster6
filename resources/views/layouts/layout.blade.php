    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin5">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5" style="background-color: #136885;">
                    <a class="navbar-brand" href="/" style="height: 65px">
                        ...
                        <b class="logo-icon" style="display: block; margin-bottom: 10px;">
                            <img src="{{ url('assets/assets/for-cluster6/LOGO_API-removebg-preview.png') }}" alt="homepage" class="light-logo"
                ...
                <a class="navbar-brand d-flex justify-content-center align-items-center" href="#" style="height: 65px">
                    <span class="logo-text mx-auto" style="font-weight: bold; font-size: 25px;">
                        Collection
                    </span>
                </a>
            </nav>
