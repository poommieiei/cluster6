    ...
    <form action="/ExportTable" method="POST">
                ...
                <tbody id="my_tbody">
                    <tr>
                        ...
                        <th id="rount" style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6">
                            <input type="text" name="rount" id="rount"
                                style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6; width: 975px; border: none">
                            <script>
                                //ข้อมูล Rount
                                var data_rount = "url";
        ...
        <div class="card-body" id="table-container-header" style="display: none">
                ...
                <tbody id="tbody_header">
                    <tr id="tr_header">
                        <th id="th_header"
                            ...
                            <input type="text" name="no_header1" id="no_header"
                        ...
                        <th id="th_header" style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6">
                            <input type="text" name="key_header1" id="key_header"
                                style="background-color: #9DC8D6; width:130px; border: none">

                        </th>
                        <th id="th_header" style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6">
                            <select name="required_param1" id="required_param"
                                style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6; border: none">
                        ...
                        <th id="th_header"
                            style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6;  text-align: center">
                            <input type="text" name="exampledata_header1" id="exampledata_header"
                                style="background-color: #9DC8D6; width: 130px; border: none">
            ...
            <div class="custom-div" style="width: 1180px; border: 1px solid dimgray; border:none">
                <div style="display: flex; justify-content: flex-end;">
                    <button onclick="addRowHeader()" type="button" id="add_row_response"
            ...
            <script>
                function addRowHeader() {
                    ...
                    $('#header_table tr:last').after(`<tr id="tr_header">
                    <th id="th_header"
                        style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6; text-align: center">
                        <input type="text" name="no_header${index}" id="no_header"
                            style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6; width:25px; border: none; text-align: center">

                    </th>

                    <th id="th_header" style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6">
                        <input type="text" name="key_header${index}" id="key_header"
                            style="background-color: #9DC8D6; width:130px; border: none">

                    </th>
                    <th id="th_header" style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6">
                        <select name="required_param${index}" id="required_param"
                            style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6; border: none">
                            <option value="o">O</option>
                            <option value="m">M</option>
                            <option value="r">R</option>
                    ...
                    <th id="th_header"
                        style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6;  text-align: center"">
                        <input type="text" name="exampledata_header${index}" id="exampledata_header"
                            style="background-color: #9DC8D6; width: 130px; border: none">

                    </th>
                    <th id="th_header"
                        style="font-size:14px; color:rgb(0, 0, 0); background-color: #9DC8D6;  text-align: center">
                        <textarea class="form-control" name="description_header${index}" id="description_header" rows="1"
                            style="font-size:14px; border:none; background:#9DC8D6; width:720px"></textarea>

                    </th>
                    {{-- สำหรับให้คลิกเพื่อเลือกว่าจะเอาหรือไม่ตอน Export --}}
                    <input type="checkbox" name="checkHeader${index}" id="checkHeader"
        ...
        <div class="card-body" id="table-container-param" style="display: none">
            <table class="table table-bordered" name="param_table" id="param_table"
                style="width:1150px; border:dimgray">
                <thead>
                    <br>
