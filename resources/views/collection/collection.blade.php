...
@section('content')
    ...
    <div class="fixed-bottom d-flex justify-content-end mb-3 me-3">
        <form action="/importjson" method="post" enctype="multipart/form-data">
            <!-- ปุ่ม Import -->
            <button type="submit" class="btn btn-primary" style="margin-right:20px; background-color:#20C997; color:#ffffff; width: 160px;">
                <i class="fas fa-download " style="margin-right: 10px;"></i> Upload
            </button>
            <!-- ปุ่ม Choose file -->
            <label for="fileUpload" class="btn btn-primary mb-0" style="margin-right:20px; background-color:#268EB0; color:#ffffff; width: 160px;">
