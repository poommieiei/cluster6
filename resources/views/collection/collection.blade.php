...
@section('content')
    @foreach ($collections as $collection)
        <div class="border border-#A19D9D border-3 d-flex align-items-center justify-content-left px-3 mt-3 mb-4 ms-5 me-5"
            ...
            <a href="/collection/{{$collection->id}}/collection/{{ $collection->id }}/table" class="text-decoration-none text-white">
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-lg"
            style="background-color:#20C997; color:#ffffff; width: 160px; font-weight: bold; position: fixed; bottom: 2%; right: 13.5%;">
            <i class="fas fa-download " style="margin-right: 10px;"></i> Import
        </button>
        <!-- ปุ่ม Choose file -->
        <label for="fileUpload" class="btn btn-lg "
            style="background-color:#268EB0; color:#ffffff; width: 160px; height:46px; position: fixed; bottom: 0.9%; right: 2%;">
